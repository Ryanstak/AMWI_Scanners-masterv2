...
class GUI(QMainWindow):
    ...
    def init_buttons(self):
        ...
        button_info = {
            ...
            "save_point": ("Save Point", self.save_point, False, False, "scan")
    ...
    def init_sublayouts(self):
        ...
        self.control_section.grid.addWidget(self.buttons["save_point"], c.val, 1)
    ...
    def set_gui_state(self, state, val):
        ...
        # Screenshot button
        self.buttons["save_point"].setEnabled(states["scan_is_running"])
